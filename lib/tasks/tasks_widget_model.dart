...
TasksWidgetModel({Key? key,required this.groupKey}){
  _setup();
}
...
class TasksWidgetModelProvider extends InheritedNotifier{
  ...
  const TasksWidgetModelProvider ({Key? key, required Widget child,required this.model}):super(key: key,child: child,notifier: model);
